...
class ExperimentManagerTest(unittest.TestCase):
    ...
    def addVariable(self):
        manager = ExperimentManager()
        manager.loadExperiment("experiment/experiment1")
        manager.addVariable("single", 1, "sissolina")
        self.assertTrue(manager.variable["sissolina"].type_ == "single")
        self.assertTrue(manager.variable["sissolina"].dim == "1")
        
    def afterAddVariable(self):
        manager = ExperimentManager()
        manager.loadExperiment("experiment/experiment1")
        self.assertTrue(manager.variable["sissolina"].type_ == "single")
        self.assertTrue(manager.variable["sissolina"].dim == "1")
    ...
    def addSample(self):
        ...
        test = manager.openExperimentTest(1)
        test.loadTestCases()
        mlp = test.openTestCase("mlp")
        mlp.addSample(["n_neuron=10"],"dataset_1.txt")
        self.assertTrue(len(mlp.samples["small"])==1)
